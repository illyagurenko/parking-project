...
* The original package name 'ru.app.parking-backend' is invalid and this project uses 'ru.app.parking_backend' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/3.5.14/reference/data/sql.html#data.sql.jdbc)
